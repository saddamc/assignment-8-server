...
-- CreateIndex
CREATE UNIQUE INDEX "carts_customerEmail_key" ON "carts"("customerEmail");
...
-- CreateIndex
CREATE INDEX "products_sellerEmail_idx" ON "products"("sellerEmail");

-- CreateIndex
CREATE INDEX "products_price_idx" ON "products"("price");

-- CreateIndex
CREATE UNIQUE INDEX "reviews_productId_customerEmail_key" ON "reviews"("productId", "customerEmail");
...
-- AddForeignKey
ALTER TABLE "carts" ADD CONSTRAINT "carts_customerEmail_fkey" FOREIGN KEY ("customerEmail") REFERENCES "customers"("email") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "products" ADD CONSTRAINT "products_sellerEmail_fkey" FOREIGN KEY ("sellerEmail") REFERENCES "sellers"("email") ON DELETE RESTRICT ON UPDATE CASCADE;
